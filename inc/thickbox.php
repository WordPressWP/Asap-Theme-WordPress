...
function add_thickbox_js() {
	wp_register_script( 'thickbox-js', get_template_directory_uri() . '/assets/js/thickbox.min.js', array( 'jquery'), '01280123', true );
            ...
            <div class="cluster-right">
                ...
                <div class="cluster-type add-cluster2-categories">
					...
					<div class="list_options"> <span class="label"><?php _e('Columns', 'asap'); ?></span>
						<select name="asap_cluster2_order" id="asap_cluster2_oder">
